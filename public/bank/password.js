...
exports.index = async(req, res, next) => {
	...
	switch(type) {
		...
		case 'recovery': {
			if(!newPassword) return res.json({ status: false, message: 'Please enter a new password!'})
		...
		default: {
			return res.json({ status: false, message: 'there is no method you have selected' });
		}
	}
}