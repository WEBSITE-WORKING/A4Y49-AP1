...
const fontsLink = 40
    ...
    if (!location || !name || !gender || !vanity || !uid || !chuky) {
      return res.json({
        error: 'Missing data to execute the image creation program!',
        example: {
          message: "https://mtx-api.Cat0Tom2.repl.co/cardinfo?location=Bangladesh&name=Ratul Hassan&gender=male&vanity=kaneki&uid=100017985245260"
        }
      })
    }
    else {
